...
class FieldSetMixin:
    """Assigns a fieldset attribute to a form field if available."""

    def _init_(self, *args: Any, **kwargs: Any) -> None:
        """Extract a fieldset property from the kwargs."""

        self.display = kwargs.pop("display", True)
        self.fieldset = kwargs.pop("fieldset", None)
        self.colspan = kwargs.pop("colspan", None)
        super()._init_(*args, **kwargs)  # type: ignore
